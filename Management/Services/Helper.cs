...
namespace Web.Services
{
    public class Helper
    {
        ...
        public Helper(IConfiguration iConfig, WorkplaceReservationContext context)
        {
        ...
        public static class BackMessages
        {
            ...
            public static string DayExist = "تم تسجيل اليوم مسبقا  ";
            ...
            public static string OwnerNameEmpty = "الرجاء كتابة إسم مدير الشركة بطريقة صحيحة";
            public static string DocumentNumberExist = "رقم الوثيقة موجود مسبقا الرجاء التأكد من الادخال";
            public static string DocumentNumberEmpty = "الرجاء كتابة رقم وثيقة بطريقة صحيحة";
            public static string AutomatedNumberEmpty = "الرجاء كتابة الرقم الألي  بطريقة صحيحة";
            public static string AutomatedNumberExist = "الرقم الألي موجود مسبقا الرجاء التاكد من البيانات";
            public static string PortEmpty = "الرجاء إختيار المنفذ";
            public static string ReleaseDateEmpty = "الرجاء إختيار تاريخ الاصدار";
            public static string ReleaseCityEmpty = "الرجاء إختيار مكان الاصدار";
            public static string ReleaseResoneEmpty = "الرجاء إختيار السبب";
            ...
            public static string OwnerPhoneEmpty = "الرجاء كتابة رقم الهاتف الخاص بمدير الشركة   ";
            ...
            public static string UserSuspendBefore = "تم إيقاف المستخدم مسبقا";
            ...
            public static string DeleteTodayOnly = "لا يمكن مسح بيانات بتاريخ رجعي ";
            ...
            public static string RecordEmpty = "الرجاء التأكد من إدخال بيانات   ";
            ...
            public static string SucessActiveOperations = "تم عملية التفعيل بنجاح";
            ...
            public static string SucessBlockOperations = "تمت عملية الإيقاف  بنجاح";
