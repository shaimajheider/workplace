...
namespace Web.Services
{
    public class Helper
    {
        ...
        public Helper(IConfiguration iConfig)
        {
        ...
        public string GenreatePass(string Year = "1995")
        {
            try
            {
                if (Year == null)
                ...
                //string pass = "Moe@" + Year + GenerateRandomNo().ToString();
                return "Traneem@" + Year + GenerateRandomNo().ToString();
        ...
        public bool IsValidPhone(string Phone)
        {
            try
            {
                ...
                if (Phone.Substring(0, 2) != "91" && Phone.Substring(0, 2) != "92" && Phone.Substring(0, 2) != "94" && Phone.Substring(0, 2) != "93")
                    return false;
        ...
        public bool IsArabhicCharacters(string text)
        {
        ...
        public bool IsEnglishCharacters(string text)
        {
        ...
        public static class BackMessages
        {
            ...
            public static string NIDEmpty = "الرجاء التأكد من إدخال الرقم الوطني";
            public static string NIDNotValid = "الرجاء التأكد من إدخال الرقم الوطني";
            ...
            public static string PhoneNotValid = "الرجاء إدخال رقم الهـاتف بطريقة الصحيحة";
            ...
            public static string NameEmpty = "الرجاء التأكد من إدخال الاسم";
            public static string NameArabhicNotValid = "اسم الطالب يجب ان يكون باللغة العربية";
            ...
            public static string GrandFatherNameEmpty = "الرجاء التأكد من إدخال الجد";
            ...
            public static string DoctorEmpty = "الرجاء اختيار إسم الدكتور";
            ...
            public static object CityIdExist = "المدينة موجودة مسبقا ";
            public static object CityIdEmpty = "الرجاء إختيار المدينة   ";
            public static object FacilityEmpty = "الرجاء إختيار المرفق الصحي   ";
            ...
            public static string WalletNotFound = "لم يتم العتور على البيانات المالية الخاص بك يرجي مراجعة الإدارة ";
            public static string WalletEmpty = "لا يوجد أي قيمة مالية داخل المحفظة الخاصه بكم يرجي تعبئة المحفظة أولا ";
            public static string WalletNotEnife = "قيمة الحافظة لاتغطي قيمة الدورة التدريبية المطلوبة";
            ...
            public static string ProgramIdEmpty = "الرجاء اختيار البرنامج المستهدف ";
            ...
            public static string PasswordNotValid = "يجب أن تتكون كلمة المرور من حروف صغيرة وكبيرو وأرقام";
            ...
            public static string AboutMeEmpty = "الرجاء إدخال النبذة الشخصية";
            ...
            public static string SucessSubscriptionsOperations = "تم خصم القيمة من المحفظة والاشتراك في الدورة التدريبية ";
            ...
            public static string SucessTransfer = "تمت عملية التحويل بنجاح";
            public static string SucessRequestOperations = "تمت عملية الطلب بنجاح";
